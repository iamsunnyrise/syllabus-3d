              ...
              <Tooltip 
                content={({ active, payload }) => {
                  if (active && payload && payload.length) {
                    ...
                    return (
                      <div className="p-3 rounded-xl bg-white/95 dark:bg-darkSurface/95 border border-slate-200 dark:border-white/10 shadow-2xl backdrop-blur-md text-xs space-y-1">
