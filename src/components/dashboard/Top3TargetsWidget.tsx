  ...
  return (
    <>
      <div className="p-3.5 sm:p-5 rounded-2xl bg-white dark:bg-[#131522] border border-slate-200/80 dark:border-white/[0.08] shadow-xs space-y-3.5 relative overflow-hidden">
          ...
          {top3Targets.map((target, idx) => {
            ...
            return (
              ...
              >
                    ...
                    <div className="space-y-2">
                      <div className="flex flex-col xs:flex-row items-stretch gap-2.5">
                        ...
                        <button
                          ...
                          className="btn-secondary flex-1 py-2 px-3 text-xs justify-center text-amber-700 dark:text-amber-300 border-amber-500/30 dark:border-amber-500/40 hover:bg-amber-50 dark:hover:bg-amber-950/20"
                          title="Choose from Syllabus"
                          aria-label="Choose from Syllabus"
                        >
                            ...
                            {filteredTopics.length === 0 ? (
                              ...
                              filteredTopics.map(t => (
                                ...
                                >
                                  ...
                                  <span className="text-2xs text-slate-400 shrink-0 ml-2 font-mono">
                                    {t.subjectName}
                                  </span>
                                </div>
                              ))
                ...
                {/* Subdued Progress / Status Cue */}
                {hasText && (
                  <div className="pt-2 border-t border-slate-200/60 dark:border-white/[0.06] flex items-center justify-between text-xs text-slate-500 dark:text-slate-400">
                    <span className="font-mono text-2xs font-bold">
                      {target.completed ? 'COMPLETED' : 'PENDING'}
                    </span>
                    {target.completed ? (
                      <span className="text-emerald-600 dark:text-emerald-400 font-bold flex items-center gap-1 text-2xs">
                        <Check className="w-3 h-3 stroke-[3]" />
                        <span>Done</span>
                      </span>
                    ) : (
                      <span className="text-amber-600 dark:text-amber-400 font-bold flex items-center gap-1 text-2xs">
        ...
        {/* Bottom Velocity Sprint Meter (Issue 6) */}
        <div className="p-3 sm:p-3.5 rounded-xl bg-slate-50/80 dark:bg-[#1B243B] border border-slate-200/70 dark:border-slate-700/60 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <span className="text-xs font-mono font-bold text-slate-700 dark:text-slate-200 shrink-0 flex items-center gap-1.5">
          ...
          <p className="text-xs font-medium text-slate-600 dark:text-slate-300 text-center sm:text-right">
            {completedTargets.length === 3
