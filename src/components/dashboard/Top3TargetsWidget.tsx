                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl bg-slate-100/70 dark:bg-white/[0.04] hover:bg-slate-200/70 dark:hover:bg-white/[0.08] text-slate-700 dark:text-slate-200 border border-dashed border-slate-300/80 dark:border-white/[0.12] text-xs font-bold transition-all cursor-pointer active:scale-95 group/btn"
                        >
                          <Plus className="w-3.5 h-3.5 text-slate-400 group-hover/btn:text-slate-700 dark:group-hover/btn:text-white transition-colors" />
                        ...
                        <button
                          ...
                          className="flex items-center gap-1.5 py-2 px-3 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 text-amber-800 dark:text-amber-200 border border-amber-500/30 dark:border-amber-500/40 text-xs font-bold transition-all cursor-pointer active:scale-95"
