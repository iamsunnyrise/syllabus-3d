import { MockTest, SubjectDefinition } from '../types/mockTracker';
import { UserSettings, ImportSummary } from '../types/mockSettings';
import { INITIAL_SAMPLE_MOCKS } from './mockSampleData';

const MOCKS_STORAGE_KEY = 'syllabus3d_mocktracker_mocks_v1';
const SETTINGS_STORAGE_KEY = 'syllabus3d_mocktracker_settings_v1';
const PLATFORMS_STORAGE_KEY = 'syllabus3d_mocktracker_custom_platforms_v1';
const SUBJECTS_CHAPTERS_STORAGE_KEY = 'syllabus3d_mocktracker_subjects_chapters_v1';
