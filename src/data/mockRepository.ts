import { MockTest, MockFilters } from '../types/mockTracker';
import { StorageService } from './mockStorageService';
...
export class MockRepository {
  ...
  resetDemoData(): MockTest[] {
    localStorage.removeItem('syllabus3d_mocktracker_mocks_v1');
