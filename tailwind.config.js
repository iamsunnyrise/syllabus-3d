  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'luminous-light': '0 1px 3px 0 rgba(15, 23, 42, 0.03), 0 10px 30px -4px rgba(15, 23, 42, 0.06), inset 0 1px 0 0 rgba(255, 255, 255, 0.95)',
        'luminous-dark': '0 10px 35px -5px rgba(0, 0, 0, 0.6), inset 0 1px 0 0 rgba(255, 255, 255, 0.12), inset 0 0 0 1px rgba(255, 255, 255, 0.04)',
        'glow-primary': '0 0 25px -3px rgba(124, 58, 237, 0.35)',
        'glow-cyan': '0 0 25px -3px rgba(34, 211, 238, 0.4)',
